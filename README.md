...
- **MediaPipe Holistic** - 1 person, 33 body + 21 + 21 hand + 468 face
  landmarks. Also produces a segmentation mask used for the Background
  blur / cutout effects.
...
styles.css       All styles (dark theme, glassmorphism, sparklines, controls)
